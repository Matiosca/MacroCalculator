...
var openModal = document.getElementById('infoIcon');
var openModalTwo = document.getElementById('infoIconTwo');
...
function calcDailyCarbKcal() {
	return (dailyCarbKcal =
		kcalDaily.value - (calcDailyProKcal() + calcDailyFatKcal()));
}
